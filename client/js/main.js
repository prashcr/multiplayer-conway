 ...
 * @param {int[]} state cols x rows array of 32bit ints containing rgba color for each cell
 */
 ...
 * @param {int} color  32bit int representing color value of the cell
 */
